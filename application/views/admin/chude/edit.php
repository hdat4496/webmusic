		...
		<form class="form" id="form" action="" method="post" enctype="multipart/form-data">
			<fieldset>
				...
				<div class="formRow">
					...
					<div class="formRight">
						<span class="oneTwo"><input name="tenChuDe" id="param_tenChuDe" _autocheck="true" value="<?php echo $info -> tenChuDe ?>" type="text"></span>
                		...
                		<span class="oneTwo">
                    		<select _autocheck="true" id="param_maNhomChuDe"  name="maNhomChuDe">
                    		     <?php foreach ($list as $row):?>
                    		       <option value="<?php echo $row->maNhomChuDe?>" <?php echo ($row->maNhomChuDe == $info->maNhomChuDe) ? 'selected' : '';?>><?php echo $row->tenNhomChuDe?></option>
                    		     <?php endforeach;?>
                    		</select>
                		</span>
