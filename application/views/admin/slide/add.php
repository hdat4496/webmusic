				...
				<div class="widget">
					...
					<div class="tab_container">
					     <div class="tab_content pd0" id="tab1" style="display: block;">
					         <div class="formRow">
                            	<label for="param_tenSilde" class="formLeft">Tên slide:<span class="req">*</span></label>
                            	<div class="formRight">
                            		<span class="oneTwo"><input type="text" _autocheck="true" id="param_tenSilde" name="tenSilde"></span>
                            		<span class="autocheck" name="name_autocheck"></span>
                            		<div class="clear error" name="tenSilde_error"></div>
                            	</div>
                            	<div class="clear"></div>
                            </div>
